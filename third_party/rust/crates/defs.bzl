...
_NORMAL_DEPENDENCIES = {
    "third_party/rust": {
        _COMMON_CONDITION: {
            ...
            "hwtrust": "@crate_index__hwtrust-0.1.0//:hwtrust",
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.half-2.5.0.bazel"),
    )
    ...
    maybe(
        new_git_repository,
        name = "crate_index__hwtrust-0.1.0",
        branch = "master",
        init_submodules = True,
        remote = "https://android.googlesource.com/platform/tools/security",
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.hwtrust-0.1.0.bazel"),
    ...
    maybe(
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.itertools-0.10.5.bazel"),
    )
